            ...
            <div className="row mt-5">
                <div className="col-sm-2">
                    <div>
                      ...
                      <Link href="/ordinary"> <span style={headingStyle}>Basic Info</span>  </Link>     <FaChevronRight className="fs-5 m-3" />
                    </div>
                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>2</span> &nbsp; &nbsp;
                 <Link href="/ordinary/experience">   <span style={headingStyle}>Experiences </span>  <FaChevronRight className="fs-5 m-3" /></Link>  

                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>3</span> &nbsp; &nbsp;
                    <Link href="/ordinary/education"><span style={headingStyle}>      Education
                    </span> </Link>   <FaChevronRight className="fs-5 m-3" />
                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>4</span> &nbsp; &nbsp;
                 <Link href="/ordinary/reference">  <span style={headingStyle}>Refrences</span></Link>      <FaChevronRight className="fs-5 m-3" />
                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>5</span> &nbsp; &nbsp;
                    
                <Link href="/ordinary/others">   <span style={headingStyle}>
                        Others
                    </span> </Link>    
                ...
                <div className="col-sm-2">
                  ...
                  <Link href="/ordinary/downloads">  <span style={headingStyle}>Download</span> </Link>   <FaChevronRight className="fs-5 m-3" />
                </div>
