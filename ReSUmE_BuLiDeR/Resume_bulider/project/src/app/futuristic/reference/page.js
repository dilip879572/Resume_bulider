    ...
    <div className="row ">
                        <div className="con-sm-12">
                            {showgithubs && (
                                <div className="input-icons">
                                    ...
                                    <label className="text-inverse" htmlFor="validationCustom01">Reference</label>
      ...
      />
        ...
        <div className="col-md-12 col-sm-12 mb-4">
                <label className="text-inverse" htmlFor="validationCustomFrom">Name</label>
                <input
                    type="text"
                    className="form-control h-100"
                    id="validationCustomFrom"
        ...
        <div className="row mt-2">
        <div className="col-md-12 col-sm-12 mb-4">
                <label className="text-inverse" htmlFor="validationCustomFrom">Contact</label>
                <input
                    type="text"
                    className="form-control h-100"
                    id="validationCustomFrom"
                    placeholder="email conatct"
                    required
                />
            </div>
        </div>
