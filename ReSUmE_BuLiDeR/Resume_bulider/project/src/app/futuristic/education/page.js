    ...
    <div className="row ">
                        <div className="con-sm-12">
                            {showgithubs && (
                                <div className="input-icons">
                                    ...
                                    <label className="text-inverse" htmlFor="validationCustom01">Add Education</label>
      ...
      />
        ...
        <div className="col-md-12 col-sm-12 mb-4">
                <label className="text-inverse" htmlFor="validationCustomFrom">Degree
</label>
            <select className="form-control h-100">
                <option>American Association for Respiratory Care Fellow (AARCF)</option>
                <option>American Registry for Radiologic Technologists (AART)</option>
                <option>Applied Cognitive Psychology (ACP)</option>
                <option>Adult Nurse Practitioner (ANP)</option>
                <option>Advanced Oncology Certified Nurse (AOCN)</option>
                <option>Advanced Oncology Certified Nurse Practitioner (AOCNP)</option>
                <option>Advanced Project Management Certification (APMC)</option>
            </select>
            </div>
        </div>
        <div className="row mt-2">
        <div className="col-md-12 col-sm-12 mb-4">
                <label className="text-inverse" htmlFor="validationCustomFrom">Institute</label>
            <select className="form-control h-100">
