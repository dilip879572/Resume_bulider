            ...
            <div className="row mt-5">
                <div className="col-sm-2">
                    <div>
                      ...
                      <Link href="/futuristic"> <span style={headingStyle}>Basic Info</span>  </Link>     <FaChevronRight className="fs-5 m-3" />
                    </div>
                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>2</span> &nbsp; &nbsp;
                 <Link href="/futuristic/experience">   <span style={headingStyle}>Experiences </span>  <FaChevronRight className="fs-5 m-3" /></Link>  

                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>3</span> &nbsp; &nbsp;
                    <Link href="/futuristic/education"><span style={headingStyle}>      Education
                    </span> </Link>   <FaChevronRight className="fs-5 m-3" />
                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>4</span> &nbsp; &nbsp;
                 <Link href="/futuristic/reference">  <span style={headingStyle}>Refrences</span></Link>      <FaChevronRight className="fs-5 m-3" />
                </div>
                <div className="col-sm-2">
                    <span style={circleStyle}>5</span> &nbsp; &nbsp;
                    
                <Link href="/futuristic/others">   <span style={headingStyle}>
                        Others
                    </span> </Link>    
                ...
                <div className="col-sm-2">
                  ...
                  <Link href="/futuristic/downloads">  <span style={headingStyle}>Download</span> </Link>   <FaChevronRight className="fs-5 m-3" />
                </div>
  ...
  */}
      ...
      <MdDeleteForever className="fs-4" onClick={handleDelete} />
        ...
        <div className="row">
           ...
           <span><h5>Minimalist</h5></span> 
                <img src="https://resume4u.io/TemplatesImg/Minimalist.webp" alt=""  style={{height:"300px"}}/> <br />
                <br />
                <br />
            <button style={{border:"none" ,  borderRadius:"5px", height:"45px", width:"100px", border:"1px solid blue", color:"white", backgroundColor:"blue", padding:"10px", textAlign:"center"}}>Select</button>                                
                    </div>
            <div className="col-sm-4">
                <span><h4>Creative
</h4></span>
            <img src="https://resume4u.io/TemplatesImg/Creative.webp" alt=""  style={{height:"300px"}}/> <br />
            <br />
            <button style={{border:"none" ,  borderRadius:"5px", height:"45px", width:"100px", border:"1px solid blue", color:"white", backgroundColor:"blue", padding:"10px", textAlign:"center"}}>Select</button>                            </div>
            <div className="col-sm-4">
                <span><h5>Professional
</h5></span>
            <img src="https://resume4u.io/TemplatesImg/Professional.webp" alt=""  style={{height:"300px"}}/> <br />
            <br />
            <button style={{border:"none" ,  borderRadius:"5px", height:"45px", width:"100px", border:"1px solid blue", color:"white", backgroundColor:"blue", padding:"10px", textAlign:"center"}}>Select</button>                            </div>
        </div>
          </Carousel.Item>
          ...
          <div className="row">
            ...
            <img src="https://resume4u.io/TemplatesImg/Futuristic.webp" alt=""  style={{height:"300px"}}/> <br />
  <br />
            <button style={{border:"none" ,  borderRadius:"5px", height:"45px", width:"100px", border:"1px solid blue", color:"white", backgroundColor:"blue", padding:"10px", textAlign:"center"}}>Select</button>                
                  </div>
            <div className="col-sm-4">
                <span><h5>Advanced</h5></span>
            <img src="https://resume4u.io/TemplatesImg/Advanced.webp" alt=""  style={{height:"300px"}}/> <br />
            <br />
            <button style={{border:"none" ,  borderRadius:"5px", height:"45px", width:"100px", border:"1px solid blue", color:"white", backgroundColor:"blue", padding:"10px", textAlign:"center"}}>Select</button>
            </div>
            <div className="col-sm-4">
            ...
            <img src="https://resume4u.io/TemplatesImg/Ordinary.webp" alt=""  style={{height:"300px"}}/> <br />
            <br />
            <button style={{border:"none" ,  borderRadius:"5px", height:"45px", width:"100px", border:"1px solid blue", color:"white", backgroundColor:"blue", padding:"10px", textAlign:"center"}}>Select</button>        </div>
        ...
        <div className="row" style={{ textAlign: "end" }}>
                        <div className="col-sm-12">
                            ...
                            <button style={{ borderRadius: "5px", color: "white", border: "0", border: "1px solid blue", padding: "", textAlign: "left", height: "50px", width: "100px", backgroundColor: "#1d3fff" ,textAlignLast:"center"}} className="m-3">Download</button>
                        </div>
                    </div>
    </div>
    <div className="col-sm-2"></div>
