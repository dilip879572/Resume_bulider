...
export default function page() {
  ...
  useEffect(() => {
    const dropdown = new Choices(document.querySelector(".choices-single"));
        ...
        <div className="col-sm-8 mt-5">
          ...
          <div className="row mt-2">
            <div className="col-md-12 col-sm-12 mb-4">
              ...
              <select
                className="form-control choices-single mt-5"
                value={degree}
                onChange={(e) => setDegree(e.target.value)}
              >
                <option></option>
                <option>
                  American Association for Respiratory Care Fellow (AARCF)
                </option>
                <option>
                  American Registry for Radiologic Technologists (AART)
                </option>
